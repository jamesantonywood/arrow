...
class C12_Elementor_Plugin {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      C12_Elementor_Plugin_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'C12_ELEMENTOR_PLUGIN_VERSION' ) ) {
			$this->version = C12_ELEMENTOR_PLUGIN_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'c12-elementor-plugin';
	 ...
	 *
	 * - C12_Elementor_Plugin_Loader. Orchestrates the hooks of the plugin.
	 * - C12_Elementor_Plugin_i18n. Defines internationalization functionality.
	 * - C12_Elementor_Plugin_Admin. Defines all hooks for the admin area.
	 * - C12_Elementor_Plugin_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-c12-elementor-plugin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-c12-elementor-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-c12-elementor-plugin-admin.php';
	 ...
	 *
	 * Uses the C12_Elementor_Plugin_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
